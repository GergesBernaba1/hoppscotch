...
function createNewRequest() {
  ...
  tabService.createNewTab({
    type: "request", // Standard string type
    request: {
      v: "1", // Version
      endpoint: "",
      wsdlUrl: "",
