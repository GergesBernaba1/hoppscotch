      ...
      >
        <div class="flex items-center">
          ...
          <h3 class="font-semibold">
            {{ request.name || "Unnamed Operation" }}
          </h3>
        </div>
      ...
      <div v-if="expanded" class="p-4 border-t border-dividerLight">
        ...
        <div class="mb-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label class="block mb-1 text-sm text-secondaryLight"
                >Endpoint URL</label
              >
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <span
                      >Browser CORS restrictions may prevent direct SOAP
                      access</span
                    >
                  </div>
                  <button
                ...
                <div class="flex items-center mt-2">
                  <input
                    ...
                    @change="toggleProxy"
                  />
                  <label for="useProxy" class="text-xs"
                    >Use CORS proxy (helps bypass browser restrictions)</label
                  >
                </div>
              </div>
            </div>
            <div>
              ...
              >
              <div
                class="p-2 bg-primaryLight border border-dividerLight rounded break-all"
              >
          ...
          <div>
            ...
            >
              <div class="flex items-center">
                ...
                >
                  <path
                    :d="bodyCollapsed ? 'M9 5l7 7-7 7' : 'M19 9l-7 7-7-7'"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                </svg>
            ...
            <div
              v-if="!bodyCollapsed"
              class="bg-primaryLight border border-dividerLight rounded"
            >
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      d="M10 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2v-8"
                    />
                    <path
                      d="M17 13l-5 5H8v-4l9-9m1.5-2.5c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5.7-1.5 1.5-1.5z"
                    />
                  </svg>
                </button>
              </div>
        ...
        <div v-if="response || loading">
          ...
          >
            <div class="flex items-center">
              ...
              >
                <path
                  :d="responseCollapsed ? 'M9 5l7 7-7 7' : 'M19 9l-7 7-7-7'"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
              </svg>
            ...
            <div>
              ...
              <span
                v-else-if="response"
                :class="getStatusClass(response.statusCode)"
              >
          ...
          <div v-if="!responseCollapsed && !loading">
            ...
            <div
              v-if="response && response.meta?.corsDetected"
            ...
            >
              <div class="flex items-center">
                ...
                <div>
                  ...
                  <p class="text-sm mt-1">
                    {{
                      response.meta?.corsMessage ||
                      "This service has CORS restrictions. Use a CORS proxy to bypass them."
                    }}
                  </p>
                </div>
              </div>
              <div class="flex items-center mt-2">
                <input
                  ...
                  @change="toggleProxy"
                />
                <label for="corsProxyToggle" class="text-sm"
                  >Use CORS proxy (helps bypass browser restrictions)</label
                >
              </div>
            </div>
            ...
            <div
              v-if="
                response?.type === 'fail' || response?.type === 'network_fail'
              "
              class="bg-red-100 dark:bg-red-900/20 border border-red-300 dark:border-red-800 rounded p-3 mb-3 text-red-800 dark:text-red-400"
            >
              <div class="flex items-center mb-2">
                <svg
                  class="w-5 h-5 mr-2"
              ...
              >
                <p class="font-medium">
                  This appears to be a CORS error. You can:
                </p>
            ...
            <div class="mb-3">
              <div
                class="flex justify-between items-center mb-1 cursor-pointer"
                @click="responseHeadersCollapsed = !responseHeadersCollapsed"
              >
                <div class="flex items-center">
                  <svg
                    class="w-4 h-4 mr-1"
                ...
                <span class="text-xs text-secondaryLight"
                  >{{ response?.headers?.length || 0 }} headers</span
                >
              </div>
              <div
                v-if="!responseHeadersCollapsed && response?.headers"
                class="bg-primaryLight border border-dividerLight rounded p-2"
              >
                <div
                  ...
                  class="text-sm py-1"
                >
                  <span class="font-medium text-accent">{{ header.key }}:</span>
                  {{ header.value }}
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="bg-primaryLight border border-dividerLight rounded">
                ...
                <div
                  v-if="response?.error"
                  class="p-2 bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200"
                >
                ...
                <div
                  ...
                  :class="{
                    'max-h-96': !showFullResponse,
                    'h-auto': showFullResponse,
                  }"
                ...
                >
                  ...
                  <div
                    v-if="!showFullResponse && isResponseOverflowing"
                ...
                <div
                  v-if="response?.body && typeof response.body === 'string'"
                ...
                >
                  ...
                  <div class="text-xs text-secondaryLight flex items-center">
                    ...
                    <span
                      v-if="isResponseOverflowing && !showFullResponse"
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    >
                      ...
                      >
                        <path
                          :d="showFullResponse 
                            showFullResponse ? 'M19 9l-7 7-7-7' : 'M9 5l7 7-7 7'
                          "
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                ...
                <div
                  v-if="!response?.body && !response?.error"
...
// UI state
const expanded = ref(
  props.initialExpanded !== undefined ? props.initialExpanded : true
)
const bodyCollapsed = ref(
  props.initialBodyCollapsed !== undefined ? props.initialBodyCollapsed : false
)
const responseCollapsed = ref(
  props.initialResponseCollapsed !== undefined
    ? props.initialResponseCollapsed
    : false
)
...
const toggleFullResponse = () => {
  ...
  const message = showFullResponse.value
    ? "Full response shown"
    : "Response collapsed"
...
watch(
  ...
  (newResponse) => {
    ...
    try {
      if (
        newResponse?.meta?.corsDetected ||
        (newResponse?.type === "network_fail" &&
          newResponse?.error?.message?.includes("CORS")) ||
        ...
        toast.info(
          "CORS restrictions detected. You can use the proxy option if needed."
        )

        // Check if we're working with a known service that always needs a proxy
        if (props.request?.endpoint?.includes("dneonline.com")) {
          toast.info(
            "Calculator service typically requires a CORS proxy for browser access."
          )
        }
      }
      ...
      if (
        newResponse?.type === "network_fail" &&
        newResponse?.error?.message?.includes(
          "Cannot read properties of undefined"
        )
      ) {
        console.error(
          'Detected "Cannot read properties" error, most likely due to proxy response handling issue'
        )
        toast.error(
          "Error processing response. Try toggling the CORS proxy option."
        )
        proxyOptionsVisible.value = true
      }
    } catch (watchError) {
...
const copyResponseToClipboard = () => {
  try {
    ...
    navigator.clipboard.writeText(
      typeof props.response.body === "string"
        ? props.response.body
        : "Binary response data"
    )
...
const getErrorMessage = (error?: { message?: string }): string => {
  ...
  if (errorMsg.includes("CORS") || errorMsg.includes("cross-origin")) {
    ...
    errorMsg.includes("SOAP-ENV:Client") ||
    errorMsg.includes("soap:Client")
  ) {
    return "SOAP Client Error: The request format was incorrect. Check your SOAP envelope and parameters."
  } else if (
    errorMsg.includes("SOAP-ENV:Server") ||
    errorMsg.includes("soap:Server")
  ) {
...
onMounted(() => {
  if (props.request?.endpoint) {
    ...
    useProxyMode.value =
      props.request.endpoint.includes("corsproxy.io") ||
...
const toggleProxy = () => {
  ...
  try {
    ...
    if (useProxyMode.value) {
      ...
      if (
        currentEndpoint.includes("corsproxy.io") ||
      ...
      try {
        ...
        proxyEndpoint =
          "https://corsproxy.io/?" + encodeURIComponent(currentEndpoint)
      } catch (encodeError) {
        ...
        try {
          ...
          proxyEndpoint =
            "https://cors-anywhere.herokuapp.com/" + currentEndpoint
        }
      }
      ...
      console.log(
        `Proxy mode enabled. Endpoint changed from ${currentEndpoint} to ${proxyEndpoint}`
      )
    } else {
      ...
      try {
        if (currentEndpoint.includes("corsproxy.io")) {
          ...
          originalUrl = decodeURIComponent(
            currentEndpoint.replace("https://corsproxy.io/?", "")
          )
          proxyDetected = true
        } else if (currentEndpoint.includes("cors-anywhere")) {
          // Handle cors-anywhere proxy
          originalUrl = currentEndpoint.replace(
          ...
          originalUrl = decodeURIComponent(
            currentEndpoint.replace("https://api.allorigins.win/raw?url=", "")
          )
          proxyDetected = true
        }
        ...
        if (proxyDetected) {
          ...
          console.log(
            `Proxy mode disabled. Endpoint changed from ${currentEndpoint} to ${originalUrl}`
          )
        } else {
    ...
    toast.error(
      `Error toggling proxy mode: ${error instanceof Error ? error.message : String(error)}`
    )
...
const updateEndpoint = (event: Event) => {
  ...
  if (target.value.includes("dneonline.com")) {
    useProxyMode.value =
      target.value.includes("corsproxy.io") ||
